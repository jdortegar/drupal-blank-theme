...
gulp.task('style', () => {
  return gulp
    .src([
      ...
      './themes/custom/gftheme/sass/**/*.scss',
    ])
    .pipe(sass())
...
gulp.task('fonts', () => {
  return gulp
    ...
    .pipe(gulp.dest('./themes/custom/gftheme/fonts'));
});
...
gulp.task(
  ...
  gulp.series(['style', 'script'], () => {
    ...
    gulp
      .watch('./themes/custom/gftheme/*.*.twig')
...
gulp.task(
  'default',
  gulp.series('style', 'serve', 'script', 'fontAwesome', 'fonts')
);
